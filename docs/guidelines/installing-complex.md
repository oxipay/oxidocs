...
If you have Bootrap installed on your website than this is the option you should choose.
All oyu need to do is copy the below HTML into your sites HTML on the pages you'd like it to be used. We recommened adding to your websites main layout page just before the closing ```</body>``` tag.
